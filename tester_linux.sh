...
cc -Wall -Wextra -Werror -lbsd -I..  -o exec/test_strlcpy tester_files/test_strlcpy.c -L.. -lft
if [ $? -ne 0 ]; then
...
cc -Wall -Wextra -Werror -lbsd -I.. -o exec/test_strlcat tester_files/test_strlcat.c -L.. -lft
if [ $? -ne 0 ]; then
...
cc -Wall -Wextra -Werror -lbsd -I.. -o exec/test_strnstr tester_files/test_strnstr.c -L.. -lft
if [ $? -ne 0 ]; then
